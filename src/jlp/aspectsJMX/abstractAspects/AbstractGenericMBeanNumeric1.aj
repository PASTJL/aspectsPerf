...
public abstract aspect AbstractGenericMBeanNumeric1 {
...
// Version for Java 1.5+
	...
	static {
		...
		System.out
				.println("Static initialisation Aspect : jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1");
		...
		String strFreqLogs = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1.frequenceMeasure",
						"1");
		...
		String strNotWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1.listNotWeave",
						"");
		...
		String strWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1.listWeave",
						"");
		...
		isGetThis = Boolean
				.parseBoolean(props
						.getProperty(
								"jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1.isGetThis",
								"true"));
		...
		String[] strDepth = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBeanNumeric1.depthIntrospect",
						"All:-1;").split(";");
		...
		try
		 {
			...
			if (hmBean.isEmpty() || !hmBean.containsKey(currentObject)) {
				...
				if (!hmInternalAttribute.containsKey(nameClass)
					...
					try {
						objName = new ObjectName("GenericMBeanNumeric1:type="
								+ shortName + ",name=" + name);
