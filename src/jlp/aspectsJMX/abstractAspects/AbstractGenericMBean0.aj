...
public abstract aspect AbstractGenericMBean0 {
...
// Version for Java 1.5+
	...
	static {
		...
		System.out
				.println("Static initialisation Aspect : jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0");
		...
		String strFreqLogs = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0.frequenceMeasure",
						"1");
		...
		String strNotWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0.listNotWeave",
						"");
		...
		String strWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0.listWeave",
						"");
		...
		isGetThis = Boolean
				.parseBoolean(props
						.getProperty(
								"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0.isGetThis",
								"true"));
		...
		String[] strDepth = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean0.depthIntrospect",
						"All:-1;").split(";");
		...
		try
		 {
			...
			if (hmBean.isEmpty() || !hmBean.containsKey(currentObject)) {
				...
				if (!hmInternalAttribute.containsKey(nameClass)
					...
					try {
						objName = new ObjectName("AbstractGenericMBean0:type="
								+ shortName + ",name=" + name);
