...
public abstract aspect AbstractGenericMBean3 {
...
// Version for Java 1.5+
	...
	static {
		...
		System.out
				.println("Static initialisation Aspect : jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3");
		...
		String strFreqLogs = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3.frequenceMeasure",
						"1");
		...
		String strNotWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3.listNotWeave",
						"");
		...
		String strWeave = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3.listWeave",
						"");
		...
		isGetThis = Boolean
				.parseBoolean(props
						.getProperty(
								"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3.isGetThis",
								"true"));
		...
		String[] strDepth = props
				.getProperty(
						"jlp.aspectsJMX.abstractAspects.AbstractGenericMBean3.depthIntrospect",
						"All:-1;").split(";");
		...
		try
		 {
			...
			if (hmBean.isEmpty() || !hmBean.containsKey(currentObject)) {
				...
				if (!hmInternalAttribute.containsKey(nameClass)
					...
					try {
						objName = new ObjectName("AbstractGenericMBean3:type="
								+ shortName + ",name=" + name);
