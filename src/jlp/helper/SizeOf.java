...
public class SizeOf {
	...
	private static long MIN_CLASS_SIZE_TO_LOG = 1024 * 1024 * 4;
	...
	public static void premain(String options, Instrumentation inst) {
		...
		System.out
				.println("JAVAGENT: call premain instrumentation for class SizeOf");
	}
	...
	private static long deepSizeOf(Object o, Map<Object, Object> doneObj,
			int depth) {
		if (o == null) {
			if (debug)
				print("null\n");
		...
		if (MIN_CLASS_SIZE_TO_LOG > 0 && size >= MIN_CLASS_SIZE_TO_LOG)
			print("Found big object: %s%s@%s size: %s\n", indent(depth), o
					.getClass().getName(), System.identityHashCode(o),
					humanReadable(size));
	...
	/**
	 * The objects processed by deepSizeOf are logged to the log output stream
	 * if their size (in byte) is greater than this value. The default value is
