...
public  abstract aspect AbstractCPUDurationSimpleMethodWithParentWithoutLine {
	...
	static {
		...
		if (tMB.isThreadCpuTimeSupported()) {
			...
			supports = true;
			System.out
					.println("AbstractCPUDurationSimpleMethodWithParentWithoutLine . Supports CPU Time for all Threads ");
		} else {
			System.out
					.println("AbstractCPUDurationSimpleMethodWithParentWithoutLine . Don t Supports CPU Time for all Threads ");
		}
		...
		if (props
				.containsKey("jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentWithoutLine.filelogs")) {
			fileTrace = dirLogs
					+ props
							.getProperty("jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentWithoutLine.filelogs");
		} else {
			fileTrace = props.getProperty("aspectsPerf.default.filelogs");
		}

		System.out
				.println("AbstractCPUDurationSimpleMethodWithParentWithoutLine fichier trace = "
						+ fileTrace);
		...
		durationMini = Double
				.parseDouble(props
						.getProperty("jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentWithoutLine.durationMini","0"));
	}
