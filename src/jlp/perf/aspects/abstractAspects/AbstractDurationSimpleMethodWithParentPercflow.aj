...
public abstract aspect AbstractDurationSimpleMethodWithParentPercflow percflow(methods()){
	...
	static {
		...
		if (props.containsKey("jlp.perf.aspects.abstractAspects.AbstractDurationSimpleMethodWithParentPercflow.filelogs")) {
			fileTrace =dirLogs+ props
					.getProperty("jlp.perf.aspects.abstractAspects.AbstractDurationSimpleMethodWithParentPercflow.filelogs");
		} else {
    ...
    System.out.println("AbstractDurationSimpleMethodsWithParent fichier trace = "+fileTrace);
		...
		durationMini = Double.parseDouble(props
				.getProperty("jlp.perf.aspects.abstractAspects.AbstractDurationSimpleMethodWithParentPercflow.durationMini"));
	}
			...
			outDurationMethods
					.append(new StringBuilder(outDurationMethods.getSdf()
							...
							.append(".").append(
								...
								append(".").append(thisEnclosingJoinPointStaticPart.getSignature().getName()).append("_line").
								append(noLine1)
							.append(sep).append(
