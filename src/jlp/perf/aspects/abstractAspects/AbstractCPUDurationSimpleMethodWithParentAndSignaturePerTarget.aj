...
public abstract aspect AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget pertarget(methods()){
	...
	static {
		...
		if (tMB.isThreadCpuTimeSupported()) {
			...
			supports = true;
			System.out
					.println("AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget . Supports CPU Time for all Threads ");
		} else {
			System.out
					.println("AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget . Don t Supports CPU Time for all Threads ");
		}
		...
		if (props
				.containsKey("jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget.filelogs")) {
			fileTrace = dirLogs
					+ props.getProperty("jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget.filelogs");
		} else {
			fileTrace = props.getProperty("aspectsPerf.default.filelogs");
		}

		System.out
				.println("AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget fichier trace = "
						+ fileTrace);
		...
		durationMini = Double
				.parseDouble(props
						.getProperty(
								"jlp.perf.aspects.abstractAspects.AbstractCPUDurationSimpleMethodWithParentAndSignaturePerTarget.durationMini",
								"0"));
	}
