...
public  aspect ConcreteJaxrpcDurationServices {
	...
	static {
		...
		if (props.containsKey("jlp.perf.aspects.concreteAspects.ConcreteJaxrpcDurationServices.filelogs")) {
			fileTrace =dirLogs+ props
					.getProperty("jlp.perf.aspects.concreteAspects.ConcreteJaxrpcDurationServices.filelogs");
		} else {
			fileTrace = props.getProperty("aspectsPerf.default.filelogs");
		}

    System.out.println("ConcreteJaxrpcDurationServices fichier trace = "+fileTrace);
		...
		durationMini = Double.parseDouble(props
				.getProperty("jlp.perf.aspects.concreteAspects.ConcreteJaxrpcDurationServices.durationMini"));
	}
