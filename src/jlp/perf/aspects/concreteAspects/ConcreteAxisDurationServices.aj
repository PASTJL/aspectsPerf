...
public  aspect ConcreteAxisDurationServices {
	...
	static {
		...
		if (props.containsKey("jlp.perf.aspects.concreteAspects.ConcreteAxisDurationServices.filelogs")) {
			fileTrace = dirLogs+props
					.getProperty("jlp.perf.aspects.concreteAspects.ConcreteAxisDurationServices.filelogs");
		} else {
    ...
    System.out.println("ConcreteAxisDurationServices fichier trace = "+fileTrace);
		...
		durationMini = Double.parseDouble(props
				.getProperty("jlp.perf.aspects.concreteAspects.ConcreteAxisDurationServices.durationMini"));
	}
		...
		if (duree/1000000 >= durationMini) {
			...
			outDurationMethods
					.append(new StringBuilder(outDurationMethods.getSdf()
							...
							sep).append(
					thisJoinPoint.getThis().getClass().getMethod("getTargetEndpointAddress",(Class[]) null).invoke(thisJoinPoint,(Object[])null))
							.append(".")
							.append(thisJoinPoint.getThis().getClass().getMethod("getOperationName",(Class[]) null)
									.invoke(thisJoinPoint,(Object[]) null).toString()).append(sep)
							.append(
				...
				else
				{
					...
					thisJoinPoint.getThis().getClass().getMethod("getTargetEndpointAddress",(Class[]) null).invoke(thisJoinPoint,(Object[])null))
							.append(".")
							.append(thisJoinPoint.getThis().getClass().getMethod("getOperationName",(Class[]) null)
									.invoke(thisJoinPoint,(Object[]) null).toString())
				...
				System.out
				.println("AspectJ LTW => ConcreteAxisDurationServices methods :"
						+ e2.getMessage());
