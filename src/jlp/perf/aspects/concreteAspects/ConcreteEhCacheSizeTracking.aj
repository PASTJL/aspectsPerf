...
public privileged aspect ConcreteEhCacheSizeTracking {
	...
	static {
		...
		if (props
				.containsKey("jlp.perf.aspects.concreteAspects.ConcreteEhCacheSizeTracking.filelogs")) {
			fileTrace = dirLogs
					+ props.getProperty("jlp.perf.aspects.concreteAspects.ConcreteEhCacheSizeTracking.filelogs");
		} else {
		...
		computeSizesInBytesEnabled = Boolean
				.parseBoolean(props
						.getProperty(
								"jlp.perf.aspects.concreteAspects.ConcreteEhCacheSizeTracking.computeSizesInBytesEnabled",
								"true"));
		...
		strFreqLogs = props
				.getProperty(
						"jlp.perf.aspects.concreteAspects.ConcreteEhCacheSizeTracking.freqLogs",
						"1");
